...
describe('Calculator', () => {
  ...
  it('should get the result 5 from adding 1 and 4', () => {
  ...
  it('should get the result 3 when 4 is subtracted from 7', () => {
    const button4 = container.find('#number4');
  ...
  it('should get the result 15 when 3 and 5 are multiplied together', () => {
  ...
  it('should get the result 3 when 21 is divided by 7', () =>{
  ...
  it('should concat consecutive numbers instead of changing running total', () => {
    ...
    expect(runningTotal.text()).toEqual('26');
  })
  ...
  it('should be able to clear the running total without affecting the overall calculation', () => {
    const button1 = container.find('#number1');
